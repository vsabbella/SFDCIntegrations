        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var i = 0; i < data.voter.Donations.length; i++) {
                    $('#voterdetails').append('<tr><td class=\'voterdetailheader\'>Donation:</td><td>' + data.voter.Donations[i].na9force__Donation_Date__c + ' - '+ data.voter.Donations[i].na9force__Candidate_Name__c +' ($'+ data.voter.Donations[i].na9force__Amount__c +')</td></tr>');
                }
            },
