...
router.get('/', function (req, res) {
    ...
    request({
        ...
        if (error) {
            ...
            request({
                url: 'https://na9force-dev-ed.my.salesforce.com/services/data/v35.0/query/?q=select+id,+name,+na9force__Political_Party__c,+na9force__Precinct__r.Name,+na9force__Mailing_Address__c+from+na9force__Voter__c+where+ na9force__Precinct__r.Name+=+%273rd District%27',
                method: 'GET',
                headers: {
